    ...
    <div className="navbar bg-base-100 shadow-md px-4">
      ...
      <div className="flex-none gap-2">
        ...
        <label className="swap swap-rotate ml-2">
          ...
          <svg className="swap-on fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5.64 17.66A9 9 0 0012 21a9 9 0 000-18 9 9 0 00-6.36 15.66z" /></svg>
